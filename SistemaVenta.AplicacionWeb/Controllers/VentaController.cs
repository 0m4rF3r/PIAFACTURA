...
namespace SistemaVenta.AplicacionWeb.Controllers
{
    ...
    public class VentaController : Controller
    {
        ...
        {
            var pdfPath = $"C:\\Proyecto\\{venta.NumeroVenta}.pdf";
            var htmlContent = ObtenerContenidoHTMLFactura(venta);
        ...
        {
            var xmlPath = $"C:\\Proyecto\\{venta.NumeroVenta}.xml";
        ...
        private string ObtenerContenidoXMLFactura(VMVenta venta)
        {
            ...
            var facturaData = new FacturaData
            {
                ...
                Empresa = new Empresa
                {
                    Nombre = "TechMarket",
                    Direccion = "Monterrey",
                    ClaveContribuyente = "ABCD123456HGF"
                },
                    ...
                    <body style=""font-family: 'Arial', sans-serif; margin: 20px; background-color: #f4f4f4;"">
                        ...
                        <div style=""max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);"">
                            ...
                            <div style=""border: 1px solid #ddd; padding: 10px; margin-bottom: 15px; border-radius: 8px;"">
                                ...
                                <p>Nombre: TechMarket</p>
                                <p>Dirección: Monterrey</p>
                                <p>Clave de Contribuyente: ABCD123456HGF</p> 
                            </div>
        ...
        public Cliente ObtenerDatosCliente(string NombreCliente)
        {
            ...
            {
                connection.Open();
                var query = $"SELECT ClienteId, Nombre, Domicilio, RFC, FechaExpedición FROM Cliente WHERE Nombre = '{NombreCliente}'";
                    ...
                    using (var lector = comando.ExecuteReader())
                    {
                        if (lector.Read())
                        {
                            return new Cliente
                            {
                                ...
                                FechaExpedicion = DateTime.Parse(lector["FechaExpedición"].ToString())
                            };
                        }
                    }
                }
        ...
        {
            string pdfPath = $"C:\\Proyecto\\{numeroVenta}.pdf";
